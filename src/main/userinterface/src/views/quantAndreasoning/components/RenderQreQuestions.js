...
import QreQuestionBlock from "./QreQuestionBlock";
import Alert from "../../../components/Alert";

function RenderQreQuestions(props) {
    ...
    return (
        ...
        <div className='flex flex-col'>
            ...
            {questionsToDisplay.map((question) => (
                <QreQuestionBlock key={question.id} question={question} testIdObject={props.testIdObject || null} getQuestions={props.getQuestions} setAlert={setAlert} />
            ))}
            <div className="">
...
export default RenderQreQuestions;
