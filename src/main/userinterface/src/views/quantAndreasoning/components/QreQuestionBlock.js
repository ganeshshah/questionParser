...
import {deleteQreQuestionById, submitQreQuestion} from "../../../services/services";

function QreQuestionBlock(props) {
    ...
    const handleSubmit = async (event) => {
        ...
        if (props.testIdObject != null) {
            try {
                const resData = await submitQreQuestion(dataToSend);
            } catch (error) {
    ...
    const confirmDelete = async () => {
        ...
        try {
            ...
            await deleteQreQuestionById(id); // Pass the question ID to your delete function.
            props.setAlert(true);
            props.getQuestions();
...
export default QreQuestionBlock;
